...
Last updated: **2026-08-23 07:21:00 (Asia/Jakarta)**
...
|---|---|
| Order | `26` |
| Canonical repository | [cfpages-adistyputriharli/epoxy.co.id](https://github.com/cfpages-adistyputriharli/epoxy.co.id) |
| Default branch | `main` |
...
| Accepted and pushed | 18 |
| Remaining | 110 |
| Repository status | ✍️ Batches 01–03 accepted and pushed; Batch 03 article parity is `01d399b6`; one earlier calibration draft remains queued for correction |
...
| 14 | `EPX-02-06` | `EPX-02` | Epoxy Anti-Static, Conductive, dan ESD | `artikel/epoxy-antistatic-conductive-esd.md` | ✅ Accepted and pushed | Batch 03 patient-reader draft passed independent current-SHA semantic acceptance, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 15 | `EPX-02-07` | `EPX-02` | Water-Based vs Solvent-Based vs 100% Solids Epoxy | `artikel/water-based-vs-solvent-based-vs-100-solids-epoxy.md` | ✅ Accepted and pushed | Batch 03 patient-reader draft passed independent current-SHA semantic acceptance, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 16 | `EPX-02-08` | `EPX-02` | Primer, Body Coat, Broadcast, dan Topcoat: Fungsi Tiap Lapis | `artikel/fungsi-lapisan-sistem-epoxy.md` | ✅ Accepted and pushed | Batch 03 patient-reader draft passed independent current-SHA semantic acceptance, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 17 | `EPX-03-01` | `EPX-03` | Cara Membaca TDS Epoxy Tanpa Salah Menafsirkan Angka | `artikel/cara-membaca-tds-epoxy.md` | ✅ Accepted and pushed | Batch 03 patient-reader draft passed independent current-SHA semantic acceptance, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 18 | `EPX-03-02` | `EPX-03` | Ketebalan Epoxy: DFT, WFT, Konsumsi, dan Verifikasi | `artikel/ketebalan-epoxy-dft-wft-konsumsi.md` | ✅ Accepted and pushed | Batch 03 patient-reader draft passed independent current-SHA semantic acceptance, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 19 | `EPX-03-03` | `EPX-03` | Uji Adhesi Epoxy: Apa yang Sebenarnya Diukur | `artikel/uji-adhesi-epoxy.md` | ✅ Accepted and pushed | Batch 03 needed two bounded repairs; its final hash passed a fresh independent re-review, leased-checkout validation, and remote parity `01d399b6`. | 2026-08-23 |
| 20 | `EPX-03-04` | `EPX-03` | Abrasi, Impak, dan Kekerasan: Memilih Data yang Relevan | `artikel/uji-abrasi-impak-kekerasan-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 21 | `EPX-03-05` | `EPX-03` | Membaca Tabel Ketahanan Kimia Epoxy | `artikel/membaca-tabel-ketahanan-kimia-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 22 | `EPX-03-06` | `EPX-03` | Uji Resistansi Lantai ESD dan Batas Klaim Anti-Static | `artikel/uji-resistansi-lantai-esd.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 23 | `EPX-03-07` | `EPX-03` | Slip Resistance Epoxy: Tekstur, Kondisi Basah, dan Perawatan | `artikel/slip-resistance-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 24 | `EPX-03-08` | `EPX-03` | Checklist Spesifikasi Epoxy Berbasis Kinerja | `artikel/checklist-spesifikasi-epoxy-berbasis-kinerja.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 25 | `EPX-04-01` | `EPX-04` | Checklist Survey Lantai Beton Sebelum Epoxy | `artikel/checklist-survey-beton-sebelum-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
...
| 35 | `EPX-05-03` | `EPX-05` | Cara Menentukan Metode Menghapus Coating Lama | `artikel/metode-menghapus-coating-lama.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 36 | `EPX-05-04` | `EPX-05` | Degreasing Beton Terkontaminasi: Batas dan Verifikasi | `artikel/degreasing-beton-terkontaminasi.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 37 | `EPX-05-05` | `EPX-05` | Detail Tepi, Sudut, Drain, dan Penetrasi pada Sistem Epoxy | `artikel/detail-tepi-sudut-drain-penetrasi-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
...
| 59 | `EPX-08-03` | `EPX-08` | Lantai Epoxy Industri Makanan dan Minuman | `artikel/epoxy-industri-makanan-minuman.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 60 | `EPX-08-04` | `EPX-08` | Epoxy untuk Area Kimia, Laboratorium, dan Secondary Containment | `artikel/epoxy-area-kimia-dan-containment.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 61 | `EPX-08-05` | `EPX-08` | Sistem Lantai untuk Cold Room dan Area Thermal Shock | `artikel/lantai-epoxy-cold-room-thermal-shock.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 62 | `EPX-08-06` | `EPX-08` | Lantai ESD untuk Elektronik dan Ruang Terkontrol | `artikel/lantai-esd-untuk-elektronik.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 63 | `EPX-08-07` | `EPX-08` | Epoxy untuk Bengkel Otomotif dan Area Maintenance | `artikel/epoxy-untuk-bengkel-otomotif.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 64 | `EPX-08-08` | `EPX-08` | Rencana Phasing Epoxy Tanpa Menghentikan Seluruh Operasi | `artikel/phasing-epoxy-fasilitas-aktif.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 65 | `EPX-09-01` | `EPX-09` | Epoxy untuk Garasi Rumah: Cocok atau Tidak? | `artikel/epoxy-untuk-garasi-rumah.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 66 | `EPX-09-02` | `EPX-09` | Epoxy untuk Parkir Basement dan Gedung | `artikel/epoxy-untuk-parkir-basement.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 67 | `EPX-09-03` | `EPX-09` | Lantai Resin untuk Rumah Sakit dan Fasilitas Kesehatan | `artikel/epoxy-untuk-fasilitas-kesehatan.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 68 | `EPX-09-04` | `EPX-09` | Epoxy untuk Dapur Komersial dan Restoran | `artikel/epoxy-untuk-dapur-komersial.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 69 | `EPX-09-05` | `EPX-09` | Epoxy untuk Kamar Mandi dan Area Basah | `artikel/epoxy-untuk-kamar-mandi-area-basah.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 70 | `EPX-09-06` | `EPX-09` | Epoxy untuk Hotel, Retail, dan Ruang Publik | `artikel/epoxy-untuk-hotel-retail-ruang-publik.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 71 | `EPX-09-07` | `EPX-09` | Desain Warna, Motif, dan Sampel Epoxy | `artikel/desain-warna-motif-dan-sampel-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 72 | `EPX-09-08` | `EPX-09` | Epoxy Outdoor: Risiko UV, Panas, Air, dan Slip | `artikel/epoxy-outdoor-risiko-dan-alternatif.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 73 | `EPX-10-01` | `EPX-10` | Epoxy Coating untuk Baja: Persiapan dan Sistem Dasar | `artikel/epoxy-coating-untuk-baja.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
...
| 95 | `EPX-12-07` | `EPX-12` | Warna Belang, Roller Mark, dan Gloss Tidak Rata | `artikel/warna-belang-dan-gloss-tidak-rata.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 96 | `EPX-12-08` | `EPX-12` | Repair Lokal, Recoat, atau Bongkar Total Epoxy? | `artikel/repair-vs-recoat-vs-bongkar-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 97 | `EPX-13-01` | `EPX-13` | Jadwal Inspeksi dan Perawatan Lantai Epoxy | `artikel/jadwal-perawatan-lantai-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 98 | `EPX-13-02` | `EPX-13` | Cara Membersihkan Lantai Epoxy Tanpa Merusak Finish | `artikel/cara-membersihkan-lantai-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 99 | `EPX-13-03` | `EPX-13` | Menghilangkan Noda, Bekas Ban, dan Tumpahan dari Epoxy | `artikel/menghilangkan-noda-pada-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 100 | `EPX-13-04` | `EPX-13` | Inspeksi Keausan Epoxy di Jalur Trafik Tinggi | `artikel/inspeksi-keausan-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 101 | `EPX-13-05` | `EPX-13` | Touch-Up Epoxy dan Mengelola Perbedaan Warna | `artikel/touch-up-epoxy-dan-perbedaan-warna.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 102 | `EPX-13-06` | `EPX-13` | Kapan Epoxy Perlu Recoat dan Cara Menilai Kesiapannya | `artikel/kapan-epoxy-perlu-recoat.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 103 | `EPX-13-07` | `EPX-13` | Membongkar Epoxy: Metode, Debu, Limbah, dan Substrat | `artikel/membongkar-lantai-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 104 | `EPX-13-08` | `EPX-13` | Lifecycle Cost Epoxy: Instalasi, Downtime, Rawat, dan Renewal | `artikel/lifecycle-cost-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 105 | `EPX-14-01` | `EPX-14` | Cara Membaca SDS Epoxy dan Hardener | `artikel/cara-membaca-sds-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 106 | `EPX-14-02` | `EPX-14` | Ventilasi dan Pengendalian Paparan Saat Aplikasi Epoxy | `artikel/ventilasi-saat-aplikasi-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 107 | `EPX-14-03` | `EPX-14` | PPE untuk Epoxy: Sarung Tangan, Mata, Kulit, dan Pernapasan | `artikel/ppe-untuk-pekerjaan-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 108 | `EPX-14-04` | `EPX-14` | Tumpahan Epoxy dan Hardener: Respons Awal yang Aman | `artikel/respons-tumpahan-epoxy-hardener.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
| 109 | `EPX-14-05` | `EPX-14` | Klaim Food Grade, Healthcare, dan Potable Water pada Epoxy | `artikel/klaim-food-grade-healthcare-potable-water-epoxy.md` | 📝 Outline prepared | Drafting has not reached accepted pushed state. | — |
