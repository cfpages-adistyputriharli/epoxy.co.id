---
article_id: EPX-12-07
title: "Warna Belang, Roller Mark, dan Gloss Tidak Rata"
slug: "warna-belang-dan-gloss-tidak-rata"
description: "Map batch, mixing, wet edge, substrate, application, lighting, and acceptable sample evidence"
status: outline
publication_date: "2026-03-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-12
primary_intent: "Diagnose appearance defects"
reader_community: "Epoxy.co.id"
reader_address: "Teman Epoxy.co.id"
final_route: "/artikel/warna-belang-dan-gloss-tidak-rata.html"
...
# Warna Belang, Roller Mark, dan Gloss Tidak Rata

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Warna Belang, Roller Mark, dan Gloss Tidak Rata”
- **Reader and situation:** Client rejecting visual inconsistency
- **Reader outcome:** Map batch, mixing, wet edge, substrate, application, lighting, and acceptable sample evidence
- **Primary intent:** Diagnose appearance defects
...
- **Scope boundary:** Excludes color-design approval owned by EPX-09-07
- **Final public route:** `/artikel/warna-belang-dan-gloss-tidak-rata.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Warna Belang, Roller Mark, dan Gloss Tidak Rata**.
...
- `/berita/warna-epoxy-lantai` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Warna Belang, Roller Mark, dan Gloss Tidak Rata”.
