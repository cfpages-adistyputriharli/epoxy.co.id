---
article_id: EPX-04-01
title: "Checklist Survey Lantai Beton Sebelum Epoxy"
slug: "checklist-survey-beton-sebelum-epoxy"
description: "Provide inspection sequence for use, history, strength indicators, cracks, contamination, moisture, and access"
status: outline
publication_date: "2025-06-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-04
primary_intent: "Perform pre-application survey"
reader_community: "Epoxy.co.id"
reader_address: "Teman Epoxy.co.id"
final_route: "/artikel/checklist-survey-beton-sebelum-epoxy.html"
...
# Checklist Survey Lantai Beton Sebelum Epoxy

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Survey Lantai Beton Sebelum Epoxy”
- **Reader and situation:** Owner, estimator, or supervisor visiting a site
- **Reader outcome:** Provide inspection sequence for use, history, strength indicators, cracks, contamination, moisture, and access
- **Primary intent:** Perform pre-application survey
...
- **Scope boundary:** Excludes preparation method owned by EPX-05-01
- **Final public route:** `/artikel/checklist-survey-beton-sebelum-epoxy.html`
- **Appointed CMS date:** `2025-06-09` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Survey Lantai Beton Sebelum Epoxy**.
...
- **Exact Markdown to insert:** `![Ilustrasi epoxy lantai 1](/wp-content/uploads/2021/02/epoxy-lantai-1.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `epoxy lantai 1` as relevant content media; no pixels were inspected.
...
- `EPX-04-02` → `/artikel/kelembapan-beton-sebelum-epoxy.html` — Kelembapan Beton Sebelum Epoxy: Sumber, Uji, dan Risiko
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Survey Lantai Beton Sebelum Epoxy”.
