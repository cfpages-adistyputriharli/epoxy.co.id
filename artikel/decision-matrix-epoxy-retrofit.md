---
article_id: EPX-06-08
title: "Decision Matrix Epoxy untuk Retrofit Gedung Aktif"
slug: "decision-matrix-epoxy-retrofit"
description: "Balance phasing, odor, dust, noise, cure, access, protection, and fallback options"
status: outline
publication_date: "2025-09-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-06
primary_intent: "Select under occupancy constraints"
reader_community: "Epoxy.co.id"
reader_address: "Teman Epoxy.co.id"
final_route: "/artikel/decision-matrix-epoxy-retrofit.html"
...
# Decision Matrix Epoxy untuk Retrofit Gedung Aktif

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Decision Matrix Epoxy untuk Retrofit Gedung Aktif”
- **Reader and situation:** Manager planning work without full shutdown
- **Reader outcome:** Balance phasing, odor, dust, noise, cure, access, protection, and fallback options
- **Primary intent:** Select under occupancy constraints
...
- **Scope boundary:** Excludes execution logistics owned by EPX-16-03
- **Final public route:** `/artikel/decision-matrix-epoxy-retrofit.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Decision Matrix Epoxy untuk Retrofit Gedung Aktif**.
...
- **Tie back to this article:** Keep the explanation specific to “Decision Matrix Epoxy untuk Retrofit Gedung Aktif”.
