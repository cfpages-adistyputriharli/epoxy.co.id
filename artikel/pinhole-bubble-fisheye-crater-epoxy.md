---
article_id: EPX-12-03
title: "Pinhole, Bubble, Fisheye, dan Crater pada Epoxy"
slug: "pinhole-bubble-fisheye-crater-epoxy"
description: "Differentiate defect appearance, timing, probable causes, prevention, and repair scale"
status: outline
publication_date: "2026-02-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-12
primary_intent: "Identify surface defects"
reader_community: "Epoxy.co.id"
reader_address: "Sobat Epoxy.co.id"
final_route: "/artikel/pinhole-bubble-fisheye-crater-epoxy.html"
...
# Pinhole, Bubble, Fisheye, dan Crater pada Epoxy

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pinhole, Bubble, Fisheye, dan Crater pada Epoxy”
- **Reader and situation:** Applicator or owner inspecting finish
- **Reader outcome:** Differentiate defect appearance, timing, probable causes, prevention, and repair scale
- **Primary intent:** Identify surface defects
...
- **Scope boundary:** Excludes broad blister diagnosis owned by EPX-12-01
- **Final public route:** `/artikel/pinhole-bubble-fisheye-crater-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pinhole, Bubble, Fisheye, dan Crater pada Epoxy**.
...
- **TOPIC-GATE:** Dated defect map, destructive/non-destructive evidence, and responsible diagnosis
...
- `EPX-12-01` → `/artikel/epoxy-blister-dan-gelembung.html` — Epoxy Blister dan Gelembung: Diagnosis Akar Masalah
- `EPX-12-02` → `/artikel/epoxy-mengelupas-atau-delaminasi.html` — Epoxy Mengelupas atau Delaminasi
- `EPX-12-04` → `/artikel/epoxy-lengket-atau-terkontaminasi.html` — Epoxy Berminyak, Lengket, atau Terkontaminasi
- `EPX-12-05` → `/artikel/retak-pada-lapisan-epoxy.html` — Retak pada Lapisan Epoxy: Substrat, Joint, atau Sistem
...
- **Tie back to this article:** Keep the explanation specific to “Pinhole, Bubble, Fisheye, dan Crater pada Epoxy”.
