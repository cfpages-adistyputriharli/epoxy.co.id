---
article_id: EPX-07-02
title: "Cara Mengukur dan Mencampur Epoxy Dua Komponen"
slug: "mengukur-dan-mencampur-epoxy-dua-komponen"
description: "Explain ratio source, whole-kit use, partial-batch controls, mixing sequence, scraping, and exotherm"
status: outline
publication_date: "2025-09-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-07
primary_intent: "Avoid mixing errors"
reader_community: "Epoxy.co.id"
reader_address: "Teman Epoxy.co.id"
final_route: "/artikel/mengukur-dan-mencampur-epoxy-dua-komponen.html"
...
# Cara Mengukur dan Mencampur Epoxy Dua Komponen

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Mengukur dan Mencampur Epoxy Dua Komponen”
- **Reader and situation:** Trained applicator following product instructions
- **Reader outcome:** Explain ratio source, whole-kit use, partial-batch controls, mixing sequence, scraping, and exotherm
- **Primary intent:** Avoid mixing errors
...
- **Scope boundary:** Excludes product-specific instructions that remain in its TDS and exotherm safety owned by EPX-01-05
- **Final public route:** `/artikel/mengukur-dan-mencampur-epoxy-dua-komponen.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Mengukur dan Mencampur Epoxy Dua Komponen**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Mengukur dan Mencampur Epoxy Dua Komponen”.
