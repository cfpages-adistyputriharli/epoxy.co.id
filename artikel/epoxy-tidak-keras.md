---
article_id: EPX-12-06
title: "Epoxy Tidak Keras: Rasio, Mixing, Suhu, dan Waktu"
slug: "epoxy-tidak-keras"
description: "Explain evidence for ratio, batch, mixing, product age, temperature, and remedy limits"
status: outline
publication_date: "2026-03-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-12
primary_intent: "Diagnose incomplete cure"
reader_community: "Epoxy.co.id"
reader_address: "Teman Epoxy.co.id"
final_route: "/artikel/epoxy-tidak-keras.html"
...
# Epoxy Tidak Keras: Rasio, Mixing, Suhu, dan Waktu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Epoxy Tidak Keras: Rasio, Mixing, Suhu, dan Waktu”
- **Reader and situation:** Applicator or buyer with soft coating
- **Reader outcome:** Explain evidence for ratio, batch, mixing, product age, temperature, and remedy limits
- **Primary intent:** Diagnose incomplete cure
...
- **Scope boundary:** Excludes universal cure-time promises; product TDS governs
- **Final public route:** `/artikel/epoxy-tidak-keras.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Epoxy Tidak Keras: Rasio, Mixing, Suhu, dan Waktu**.
...
- `EPX-12-07` → `/artikel/warna-belang-dan-gloss-tidak-rata.html` — Warna Belang, Roller Mark, dan Gloss Tidak Rata
- `EPX-12-08` → `/artikel/repair-vs-recoat-vs-bongkar-epoxy.html` — Repair Lokal, Recoat, atau Bongkar Total Epoxy?
...
- **Tie back to this article:** Keep the explanation specific to “Epoxy Tidak Keras: Rasio, Mixing, Suhu, dan Waktu”.
