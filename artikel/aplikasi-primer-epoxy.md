---
article_id: EPX-07-03
title: "Aplikasi Primer Epoxy dan Tanda Substrat Bermasalah"
slug: "aplikasi-primer-epoxy"
description: "Explain coverage, absorption, pinholes, pooling, contamination clues, and hold/stop decisions"
status: outline
publication_date: "2025-09-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-07
primary_intent: "Apply and inspect primer"
reader_community: "Epoxy.co.id"
reader_address: "Sobat Epoxy.co.id"
final_route: "/artikel/aplikasi-primer-epoxy.html"
...
# Aplikasi Primer Epoxy dan Tanda Substrat Bermasalah

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Aplikasi Primer Epoxy dan Tanda Substrat Bermasalah”
- **Reader and situation:** Applicator at the first coating stage
- **Reader outcome:** Explain coverage, absorption, pinholes, pooling, contamination clues, and hold/stop decisions
- **Primary intent:** Apply and inspect primer
...
- **Scope boundary:** Excludes substrate acceptance owned by EPX-05-08
- **Final public route:** `/artikel/aplikasi-primer-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Aplikasi Primer Epoxy dan Tanda Substrat Bermasalah**.
...
- `EPX-07-01` → `/artikel/tahapan-aplikasi-epoxy.html` — Tahapan Aplikasi Epoxy dari Primer hingga Handover
- `EPX-07-02` → `/artikel/mengukur-dan-mencampur-epoxy-dua-komponen.html` — Cara Mengukur dan Mencampur Epoxy Dua Komponen
- `EPX-07-04` → `/artikel/teknik-broadcast-agregat-dan-back-roll.html` — Teknik Broadcast Agregat dan Back-Roll
- `EPX-07-05` → `/artikel/wet-edge-dan-pembagian-area-epoxy.html` — Menjaga Wet Edge dan Membagi Area Kerja Epoxy
...
- **Tie back to this article:** Keep the explanation specific to “Aplikasi Primer Epoxy dan Tanda Substrat Bermasalah”.
